...
{
    const string assetPath = "Assets/EventRecorder/SimcoachLogin/UniWebView/Editor/settings.asset";
...
public static class UniWebViewSettingsProvider {
    public static SerializedObject settings;
    ...
    public static void SetAuthCallbackURLs(string eventID)
    {
        if (settings == null)
        {
            settings = UniWebViewEditorSettings.GetSerializedSettings();
