//WTP NOTE: The below is the original define
//#if UNITY_EDITOR_WIN || UNITY_EDITOR_LINUX || (!UNITY_EDITOR_OSX && !UNITY_STANDALONE_OSX && !UNITY_IOS && !UNITY_ANDROID)

//WTP NOTE: This is the one I have edited to exclude the windows case
#if UNITY_EDITOR_LINUX 
using UnityEngine;

//WTP NOTE: This is the UniWebViewInterface that is active by default in editor / on windows / other platforms UniWebView does NOT support
//I have created a custom Windows interface called UniWebViewWindows that provides some VERY limited behavior for UniWebView.
//Basically just enough to get an OAuth code flow working.
