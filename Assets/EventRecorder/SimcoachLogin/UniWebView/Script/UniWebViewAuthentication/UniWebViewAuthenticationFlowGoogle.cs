...
public class UniWebViewAuthenticationFlowGoogle : UniWebViewAuthenticationCommonFlow, IUniWebViewAuthenticationFlow<UniWebViewAuthenticationGoogleToken> {
    ...
    public UnityEvent<string> OnSignOutFinished { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    public UnityEvent<string> OnSignOutErrored { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
}
