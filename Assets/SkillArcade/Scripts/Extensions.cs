...
namespace Simcoach.SkillArcade
{
    ...
    {
        public static void Pause(this UITweener_SA t)
        {
            t.enabled = false;
        }

        public static void PlayForward_FromBeginning(this UITweener_SA t)
        {
            t.SetForward();
            t.ResetToBeginning();
            t.PlayForward();
        }
        public static void PauseForward_FromBeginning(this UITweener_SA t)
        {
            t.SetForward();
            t.ResetToBeginning();
            t.Pause();
        }
        public static void PlayReverse_FromBeginning(this UITweener_SA t)
        {
            t.SetReverse();
            t.ResetToBeginning();
            t.PlayReverse();
        }
        public static void PauseReverse_FromBeginning(this UITweener_SA t)
        {
            t.SetReverse();
            t.ResetToBeginning();
            t.Pause();
