...
{
    public abstract class UITweener_SA : MonoBehaviour
    {
        /// <summary>
        /// Current tween that triggered the callback function.
        /// </summary>

        static public UITweener_SA current;
        ...
        public AnimationOrTween_SA.Direction direction { get { return amountPerDelta < 0f ? AnimationOrTween_SA.Direction.Reverse : AnimationOrTween_SA.Direction.Forward; } }
       ...
       */
        ...
        static public T Begin<T>(GameObject go, float duration) where T : UITweener_SA
        {
