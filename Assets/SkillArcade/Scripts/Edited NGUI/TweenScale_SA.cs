...
namespace Simcoach.SkillArcade
{
    ...
    public class TweenScale_SA : UITweener_SA
    {
        ...
        static public TweenScale_SA Begin(GameObject go, float duration, Vector3 scale)
        {
            TweenScale_SA comp = UITweener_SA.Begin<TweenScale_SA>(go, duration);
