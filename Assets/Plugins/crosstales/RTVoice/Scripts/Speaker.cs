...
namespace Crosstales.RTVoice
{
    ...
    public class Speaker : Crosstales.Common.Util.Singleton<Speaker>
    {
        ...
        [Header("Custom Provider"), Tooltip("Custom provider for RT-Voice."), SerializeField]
        private Crosstales.RTVoice.Provider.BaseCustomVoiceProvider customProvider;

        [FormerlySerializedAs("CustomMode")]
        [Tooltip("Enable or disable the custom provider (default: false)."), SerializeField]
        private bool customMode;

        [FormerlySerializedAs("ESpeakMode")]
        [Header("eSpeak Settings"), Tooltip("Enable or disable eSpeak for standalone platforms (default: false)."), SerializeField]
        ...
        [Tooltip("Active modifier for all eSpeak voices (default: none, m1-m6 = male, f1-f4 = female)."), SerializeField]
        ...
        [Header("Android Settings"), Tooltip("Active speech engine under Android (default: empty)."), SerializeField]
        ...
        [Header("Advanced Settings"), Tooltip("Automatically clear tags from speeches depending on the capabilities of the current TTS-system (default: false)."), SerializeField]
        ...
        [Header("Behaviour Settings"), Tooltip("Silence any speeches if this component gets disabled (default: false)."), SerializeField]
        private bool silenceOnDisable;

        [FormerlySerializedAs("SilenceOnFocusLost")]
        [FormerlySerializedAs("SilenceOnFocustLost")]
        [Tooltip("Silence any speeches if the application loses the focus. Otherwise the speeches are paused and unpaused (default: false)."), SerializeField]
                        ...
                        else
                        {
                            ...
                            if (!voiceProvider.isSpeakNativeSupported) //add an AudioSource for providers without native support
                            {
                                if (wrapper.Source == null)
                                {
                                    ...
                                    wrapper.Source.outputAudioMixerGroup = SimpleRTVoiceExample.Instance.voiceMixerGroup;
